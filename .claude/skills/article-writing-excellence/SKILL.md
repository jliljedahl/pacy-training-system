---
name: article-writing-excellence
description: Enhances article writing with advanced narrative techniques, word economy, and reader engagement strategies. Use when writing articles, creating content, or when the article-writer agent needs to improve writing quality, maintain word count discipline, or enhance reader engagement.
---

# Article Writing Excellence

This Skill provides advanced techniques for creating exceptional articles that are engaging, concise, and impactful.
...
- Balance familiar concepts with new perspectives
...
4. **Condense transitions**: Let ideas flow naturally
...
4. Tighten remaining sentences
5. Verify word count and cut more if needed
...
- Eliminate filler words ("very", "really", "quite", "somewhat")

## Checklist Before Submission

- [ ] Word count: 800-1000 (prefer shorter end)
- [ ] Opening hooks reader immediately
- [ ] Paragraphs are 3-5 lines maximum
- [ ] Conversational, professional tone throughout
- [ ] Concrete, role-specific examples included
- [ ] Theory-practice balance (~30-40% / 60-70%)
- [ ] No checklist drift (narrative maintained)
- [ ] Conclusion has momentum (not exhaustive summary)
- [ ] Sources properly formatted
- [ ] Scannable structure with clear sections
- [ ] Every sentence serves a purpose
- [ ] Active voice used throughout
- [ ] Reader addressed directly ("you")

## Common Pitfalls to Avoid

1. **Checklist drift**: Converting narrative into bullet points
2. **Over-explanation**: Explaining simple concepts at length
3. **Under-explanation**: Assuming reader knows too much
4. **Example overload**: Too many examples, not enough insight
5. **Weak conclusions**: Summarizing instead of inspiring action
6. **Word count violations**: Exceeding limits due to lack of discipline
7. **Tone inconsistency**: Mixing casual and formal language
8. **Abstract over concrete**: Theory without practical application
