...
- Repetitive phrasing
- Exhaustive conclusion summaries

**RESIST THE URGE** to be comprehensive. Focus on core objectives.
...
[Content with SHORT paragraphs (3-5 lines)]
[Mix of explanation and example]

## [Section 2 Title]

[Continue building the topic]
...
✅ Reinforce the core insight (1-2 sentences)
✅ Provide clear takeaway or next action
✅ End with momentum ("Now you're equipped to..." or "Next time you face this...")

**Your conclusion should NOT**:
❌ Summarize every point from the article
❌ Present a numbered list of takeaways
...
and adjust based on results. The next time [scenario] happens,
...
Ehrenberg-Bass Institute. (2023). Mental Availability Research.
https://www.ehrenberg-bass.com/research
...
- ✅ Sources properly formatted and included
...
- **Adjust tone** if too academic
- **Fix sources** if improperly formatted
...
- "Serve the learner" - Practical > theoretical
